...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 11, 2018 lúc 04:43 AM
...
(5, 'nguyenvanson2@gmail.com', '25f9e794323b453885f5181f1b624d0b', 'demo123455656', NULL, NULL, 0);
...
(7, 'D180145', 45, 0, 0, 0),
(8, 'D180150', 50, 0, 0, 0),
(9, 'MOPLQIUZ', 12, 1514934000, 1517353200, 0);
...
(12, 1, '\"Sửa chữa\" Facebook là mục tiêu trong năm 2018 của CEO Mark Zuckerberg', 'anh121.jpg', '<p>\r\n	Trang Reuters mới đ&acirc;y cho biết, Mark Zuckerberg - CEO Facebook đ&atilde; chia sẻ v&agrave;o h&ocirc;m thứ năm (4/1) rằng: Mục ti&ecirc;u trong năm 2018 của &ocirc;ng sẽ l&agrave; đưa việc kinh doanh l&ecirc;n một chỗ đứng vững chắc hơn cũng như sẽ &quot;sửa chữa&quot; Facebook để ph&ugrave; hợp với cả thế giới. &quot;Thế giới đang cảm thấy lo lắng v&agrave; chia rẽ, v&agrave; Facebook c&oacute; rất nhiều việc phải l&agrave;m&quot;, Mark đ&atilde; chia sẻ th&ocirc;ng điệp n&agrave;y l&ecirc;n trang c&aacute; nh&acirc;n của m&igrave;nh. Điều đ&oacute; cho thấy, ngo&agrave;i những mục ti&ecirc;u d&agrave;i hạn đ&atilde; đặt ra từ l&acirc;u như học tiếng Quan Thoại (ng&ocirc;n ngữ của gia đ&igrave;nh vợ), đọc 2 cuốn s&aacute;ch mỗi th&aacute;ng v&agrave; chu du đến c&aacute;c tiểu bang chưa từng đến ở Mỹ th&igrave; vị CEO 33 tuổi n&agrave;y c&ograve;n muốn đổi mới Facebook. Được biết hiện tại ở một số quốc gia phương T&acirc;y, Facebook đang bị chỉ tr&iacute;ch l&agrave; một c&ocirc;ng cụ l&agrave;m ti&ecirc;u tốn thời gian v&agrave; ph&aacute;t t&aacute;n những th&ocirc;ng điệp th&ugrave; địch v&ocirc; kiểm so&aacute;t. Trong khi ở Đức, người ta đ&atilde; bắt đầu ban h&agrave;nh những đạo luật y&ecirc;u cầu c&aacute;c mạng x&atilde; hội như Facebook v&agrave; Twitter phải kiểm duyệt, loại bỏ những b&agrave;i đăng c&oacute; t&iacute;nh th&ugrave; địch, khi&ecirc;u kh&iacute;ch cộng đồng nếu kh&ocirc;ng sẽ nhận &aacute;n phạt. Th&igrave; ở Mỹ, Facebook đ&atilde; bị l&ecirc;n &aacute;n v&igrave; để Nga can thiệp v&agrave;o cuộc bầu cử năm 2016 bằng c&ocirc;ng cụ n&agrave;y. Như vậy c&oacute; thể thấy, việc CEO Mark Zuckerberg phải đăng đ&agrave;n giải b&agrave;y v&agrave; đặt ra mục ti&ecirc;u mới để ph&aacute;t triển Facebook l&agrave; v&ocirc; c&ugrave;ng cần thiết. &Ocirc;ng cho biết, &quot;th&aacute;ch thức c&aacute; nh&acirc;n trong năm 2018 sẽ l&agrave; sửa chữa những vấn đề quan trọng&quot;, &quot;ch&uacute;ng t&ocirc;i sẽ kh&ocirc;ng thể ngăn chặn hết những (b&agrave;i đăng c&oacute; t&iacute;nh chất) sai lầm v&agrave; lạm dụng nhưng Facebook đang cố l&agrave;m nhiều thứ để hạn chế điều n&agrave;y&quot;.</p>\r\n', 256, 1515640383);
...
(31, 2, 4, 'Dây cáp Micro USB 0.2', 'anhd.jpg', '<p>\r\n	D&ugrave;ng được cho c&aacute;c thiết bị d&ugrave;ng cổng Micro USB. Chất lượng tương đương với h&agrave;ng ch&iacute;nh h&atilde;ng. D&ugrave;ng để ch&eacute;p dữ liệu hay sạc pin (d&ugrave;ng với adapter ri&ecirc;ng). D&acirc;y ngắn 20 cm th&iacute;ch hợp để d&ugrave;ng với pin sạc dự ph&ograve;ng hay kết nối m&aacute;y t&iacute;nh... Th&ocirc;ng số kỹ thuật Jack cắm: Micro USB T&iacute;nh năng: Sạc, Truyền dữ liệu D&ograve;ng sạc tối đa: 2A Độ d&agrave;i d&acirc;y: 20 cm</p>\r\n', 30, 1518217200, 40000, 1515456000, 7),
(32, 4, 1, 'Pin sạc dự phòng 5.000 mAh', 'anhe.jpg', '<p>\r\n	Thiết kế bắt mắt với họa tiết caro, lắc để hiện dung lượng pin độc đ&aacute;o.</p>\r\n<p>\r\n	Sạc 2 lần thiết bị pin dưới 1.500 mAh, 1 lần dưới 3.500 mAh.</p>\r\n<p>\r\n	Dễ d&agrave;ng kiểm tra lại được dung lượng pin c&ograve;n lại trong sạc.</p>\r\n<p>\r\n	Sử dụng l&otilde;i pin Li-Ion an to&agrave;n. Sạc được cho mọi điện thoại v&agrave; m&aacute;y t&iacute;nh bảng. Bộ sản phẩm gồm: pin sạc.</p>\r\n<p>\r\n	Th&ocirc;ng số kỹ thuật</p>\r\n<p>\r\n	Hiệu suất sạc: 65%</p>\r\n<p>\r\n	Đ&egrave;n LED b&aacute;o hiệu: C&oacute;</p>\r\n<p>\r\n	Thời gian sạc: 5 - 6 giờ (d&ugrave;ng Adapter 1A), 2 - 3 giờ (d&ugrave;ng Adapter 2.1A)</p>\r\n<p>\r\n	Nguồn v&agrave;o: 5V - 2A</p>\r\n<p>\r\n	L&otilde;i pin: Pin Li-Ion</p>\r\n<p>\r\n	Cổng ra USB 1: 5V - 1A</p>\r\n<p>\r\n	Cổng ra USB 2: 5V - 2.1A</p>\r\n<p>\r\n	K&iacute;ch thước: D&agrave;i 9.5 cm - ngang 4.8 cm - d&agrave;y 2 cm</p>\r\n<p>\r\n	Trọng lượng: 200 g</p>\r\n', 5, 1515538800, 200000, 1515456000, 0),
(33, 3, 1, 'Gậy chụp ảnh Osmia', 'anhf.jpg', '<p>\r\n	h&acirc;n gậy họa tiết ch&uacute; gấu Brown nổi tiếng ngộ nghĩnh.</p>\r\n<p>\r\n	Ph&ugrave; hợp với nhiều d&ograve;ng điện thoại dưới 6 inch kh&aacute;c nhau</p>\r\n<p>\r\n	. Kh&ocirc;ng cần hẹn giờ, chỉ cần ấn n&uacute;t tr&ecirc;n th&acirc;n gậy để chụp ảnh.</p>\r\n<p>\r\n	Độ d&agrave;i gậy c&oacute; thể k&eacute;o d&agrave;i l&ecirc;n đến 80 cm.</p>\r\n<p>\r\n	Đầu gậy c&oacute; thể gập mở g&oacute;c 270 độ t&ugrave;y bạn lựa chọn.</p>\r\n<p>\r\n	Th&ocirc;ng số kỹ thuật Kiểu kết nối:</p>\r\n<p>\r\n	D&ugrave;ng d&acirc;y 3.5 mm</p>\r\n<p>\r\n	Độ d&agrave;i tối thiểu: 30 cm</p>\r\n<p>\r\n	Độ d&agrave;i tối đa: 80 cm</p>\r\n<p>\r\n	Tương th&iacute;ch: Điện thoại dưới 6 inch</p>\r\n', 10, 1515538800, 70000, 1515456000, 1),
(34, 5, 5, 'Miếng dán màn hình Nokia 6', 'anhg.jpg', '<p>\r\n	Miếng d&aacute;n c&oacute; độ d&agrave;y 30 micr&ocirc; m&eacute;t.</p>\r\n<p>\r\n	Bảo h&agrave;nh 3 th&aacute;ng d&aacute;n lại tối đa 3 lần miễn ph&iacute; cho trường hợp bong tr&oacute;c, trầy xước.</p>\r\n<p>\r\n	Chống trầy xước tối ưu cho m&agrave;n h&igrave;nh điện thoại Nokia 6 L&agrave;m giảm c&aacute;c dấu v&acirc;n tay v&agrave; vết ố Chất liệu Nhật Bản v&agrave; đ&oacute;ng g&oacute;i tại Đ&agrave;i Loan.</p>\r\n', 0, 1515538800, 60000, 1515456000, 0),
(35, 5, 3, 'Miếng dán màn hình Oppo F5', 'anhh.jpg', '<p>\r\n	Miếng d&aacute;n c&oacute; độ d&agrave;y 30 micr&ocirc; m&eacute;t.</p>\r\n<p>\r\n	Bảo h&agrave;nh 3 th&aacute;ng d&aacute;n lại tối đa 3 lần miễn ph&iacute; cho trường hợp bong tr&oacute;c, trầy xước.</p>\r\n<p>\r\n	Chống trầy xước tối ưu cho m&agrave;n h&igrave;nh điện thoại Oppo F5 L&agrave;m giảm c&aacute;c dấu v&acirc;n tay v&agrave; vết ố Chất liệu Nhật Bản v&agrave; đ&oacute;ng g&oacute;i tại Đ&agrave;i Loan</p>\r\n', 0, 1515538800, 60000, 1515456000, 0),
(36, 5, 1, 'Miếng dán lưng iPhone X', 'anhi.jpg', '<p>\r\n	Miếng d&aacute;n c&oacute; độ d&agrave;y 30 micr&ocirc; m&eacute;t.</p>\r\n<p>\r\n	Bảo h&agrave;nh 3 th&aacute;ng d&aacute;n lại tối đa 3 lần miễn ph&iacute; cho trường hợp bong tr&oacute;c, trầy xước.</p>\r\n<p>\r\n	Chống trầy xước tối ưu cho mặt lưng điện thoại iPhone X L&agrave;m giảm c&aacute;c dấu v&acirc;n tay v&agrave; vết ố Chất liệu Nhật Bản v&agrave; đ&oacute;ng g&oacute;i tại Đ&agrave;i Loan</p>\r\n', 0, 1515538800, 60000, 1515456000, 0),
(37, 2, 2, 'Thẻ nhớ Micro SD 8 GB', 'anhk.jpg', '<p>\r\n	Tốc độ đọc: 30 MB/s.</p>\r\n<p>\r\n	Tốc độ ghi: 4 MB/s.</p>\r\n<p>\r\n	Ch&eacute;p một video 1 GB v&agrave;o thẻ nhớ trong gần 4 ph&uacute;t rưỡi.</p>\r\n<p>\r\n	Tương th&iacute;ch với hầu hết tất cả thiết bị (điện thoại, m&aacute;y t&iacute;nh bảng).</p>\r\n<p>\r\n	Lưu trữ hơn 2.600 b&agrave;i h&aacute;t (1 b&agrave;i ~3 MB).</p>\r\n', 0, 1515538800, 100000, 1515456000, 0),
(38, 2, 2, 'Thẻ nhớ Micro SD 16 GB', 'anhg.jpg', '<p>\r\n	Thương hiệu uy t&iacute;n: Transcend, Apacer, SanDisk.</p>\r\n<p>\r\n	Tốc độ đọc: 30 MB/s</p>\r\n<p>\r\n	Tốc độ ghi: 10 MB/s</p>\r\n<p>\r\n	Kh&ocirc;ng k&eacute;n thiết bị nhận, dễ d&agrave;ng sử dụng.</p>\r\n<p>\r\n	Lưu trữ hơn 15.500 tấm ảnh (1 tấm ~1.5 MB).</p>\r\n<p>\r\n	Ch&eacute;p một video dung lượng 1 GB v&agrave;o thẻ chưa tới 2 ph&uacute;t.</p>\r\n<p>\r\n	Tương th&iacute;ch với hầu hết tất cả thiết bị (điện thoại, m&aacute;y t&iacute;nh bảng).</p>\r\n', 0, 1515538800, 150000, 1515456000, 2),
(39, 2, 2, 'Thẻ nhớ Micro SD 32', 'anhh.jpg', '<p>\r\n	Thương hiệu uy t&iacute;n: Transcend, Apacer.</p>\r\n<p>\r\n	Tốc độ đọc: 30 MB/s;</p>\r\n<p>\r\n	Tốc độ ghi: 10 MB/s;</p>\r\n<p>\r\n	Kh&ocirc;ng k&eacute;n thiết bị nhận, dễ d&agrave;ng sử dụng.&nbsp;</p>\r\n<p>\r\n	Ch&eacute;p một video dung lượng 1 GB v&agrave;o thẻ chưa tới 2 ph&uacute;t.</p>\r\n<p>\r\n	Tương th&iacute;ch với hầu hết tất cả thiết bị (điện thoại, m&aacute;y t&iacute;nh bảng).</p>\r\n', 0, 1515538800, 200000, 1515456000, 5);
...
(4, 31, 'cvbcv', 'vbv', 'bvcb', 'bcvbcvbcv', 1515637751, 1515637813, 28000, 1, 1, 'Lần cuối thay đổi: 11-01-2018 03:30:13'),
(5, 31, 'cvbcv', 'vbv', 'bvcb', 'bcvbcvbcv', 1515637965, 1515637982, 28000, 1, 0, 'Lần cuối thay đổi: 11-01-2018 03:33:02'),
(6, 31, 'gfdg', 'fgdg', 'fdgfd', 'ffđg', 1515638607, 0, 28000, 0, 0, ''),
(7, 31, 'gfdg', 'fgdg', 'fdgfd', 'ffđg', 1515638705, 0, 28000, 0, 0, ''),
(8, 31, 'gfdg', 'fgdg', 'fdgfd', 'ffđg', 1515638773, 0, 28000, 0, 0, ''),
(9, 31, 'gfdg', 'fgdg', 'fdgfd', 'ffđg', 1515638919, 0, 28000, 0, 0, ''),
(10, 31, 'fghgf', 'fgh', 'fh', 'hfghfg', 1515639069, 0, 28000, 0, 0, ''),
(11, 31, 'fghgf', 'fgh', 'fh', 'hfghfg', 1515639191, 0, 28000, 0, 0, ''),
(12, 31, 'fghgf', 'fgh', 'fh', 'hfghfg', 1515639205, 0, 28000, 0, 0, '');
