						...
						<tr>
							...
							<td class="item">
								<select name="supplier">
									...
									<option value="<?php echo $row->id?>" <?php echo ($this->input->get('supplier') == $row->id) ? 'selected' : ''?>><?php echo $row->name?></option>
									<?php endforeach;?>
								</select>
							</td>
			...
			<tbody class="list_item">
				...
				<tr class="row_<?php echo $row->id?>">
					...
					<td class="textR">
						...
						<b style="color:red"><?php echo number_format($price_new,0,',','.')?> đ</b>
						<p style="text-decoration:line-through"><?php echo number_format($row->price,0,',','.')?> đ</p>
						<?php else:?>
						<b style="color:red"><?php echo number_format($row->price,0,',','.')?> đ</b>
						<?php endif;?>
					</td>
